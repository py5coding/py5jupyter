...
# -*- coding: utf-8 -*-
#
# py5jupyter documentation build configuration file
#
...
_version_py = os.path.join(repo, 'py5jupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'py5jupyterdoc'
...
latex_documents = [
    (master_doc, 'py5jupyter.tex', 'py5jupyter Documentation',
     'Jim Schmitz', 'manual'),
]
